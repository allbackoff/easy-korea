        ...
        <Switch>
          {!user ? (
            ...
            <Route
              path="/mypage"
              render={(props) => (
                <Page {...props} handleLogout={handleLogout} user={user} />
              )}
            />
          )}
          ...
          <Route
            exact
            path="/guides/documents/residency"
            component={residency}
          />
          ...
          <Route
            exact
            path="/emergency/give/confirm"
            component={EmergencyConfirm}
          />
          <Route
            exact
          ...
          />
          <Route
            path="/emergency/receive/"
            component={EmergencyReceiveConfirmation}
          />
